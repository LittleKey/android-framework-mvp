...
public class BaseSwipeRefreshLayout extends ViewGroup {
    ...
    private MvpProgressDrawable mProgress;
//    private SwipeRefreshDrawable mProgress;
...
//            mCircleView.setBackground(null);
//        } else {
//            mCircleView.setBackgroundDrawable(null);
//        }
        mCircleView.setImageDrawable(mProgress);
        mCircleView.setVisibility(View.GONE);
        addView(mCircleView);
    ...
    private void setTargetOffsetTopAndBottom(int offset, boolean requiresUpdate) {
        ...
        mCurrentTargetOffsetTop = mCircleView.getTop();
        // TODO : notify refresh drawable offset
